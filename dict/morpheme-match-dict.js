module.exports = [
  ...
  {
    message:
      '「$1」と「$2」接続詞が二つ続いています（接続助詞と格助詞） err13-2',
    //話を聞いたのでで、行くことにした。
    tokens: [
      {
        pos_detail_1: '接続助詞',
  ...
  {
    message:
      '「$1」と「$2」不自然な助詞の連続があります（係助詞から格助詞） err13-3',
    //造作はに拘っていない。
    tokens: [
      {
        pos_detail_1: '係助詞',
  ...
  {
    message:
      '「$1」と「$2」不自然な助詞の連続があります（副詞化の助詞から格助詞） err13-4',
    //物語は緊密にに構成されている。
    tokens: [
      {
        pos: '助詞',
  ...
  {
    message:
      '「$1$2。」で文章が終わっています。~れる。~れた。などと続く可能性があります err14',
    //その本は読まれ。
    expected: '$1$2た',
    tokens: [
      {
  ...
  {
    message:
      '連用形の動詞「$1」で文が終わっています。「$1ました」の誤記の可能性があります err15',
    tokens: [
      {
        pos: '動詞',
        pos_detail_1: '自立',
  ...
  {
    message:
      '連用形の「$1」で文が終わっています。「$1た」の誤記の可能性があります err16',
    tokens: [
      {
